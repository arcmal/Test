...
<body>
    ...
    <center>
<form class="login-container" METHOD="POST" name='form-login' onSubmit="return validate()" action="editQuestion_process.php?id=<?php echo $question2['id']; ?>" > 
<table width="969">
  <thead>
     <tr>
     ...
     <tr>
      ...
      <td><button name="submit" class="secondary" onclick= "return confirm('Update Question?');"> Update Question</button></td>
    </tr>
