...
$question = mysql_query("SELECT * FROM question_result WHERE id='$id_survey'");
...
<body>
    ...
    <center>
<form class="login-container" METHOD="POST" name='form-login' onSubmit="return validate()" action="editSurvey_process.php?id=<?php echo $survey2['id_survey']; ?>" > 
<table width="969">
  <thead>
     <tr>
      <th width="400"><center>Survey Name</center></th>
      <td><input type="text" name="survey" value="" size="140" required="required"></td>
    </tr>
     <tr>
      <th width="400"><center>Action</center></th>
      <td><button name="submit" class="secondary" onclick= "return confirm('Update Survey Name?');"> Update Survey Name</button></td>
    </tr>
